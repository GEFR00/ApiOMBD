...
<body>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-main">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="/cdn-cgi/l/email-protection#d1b3b7a3b8a5ab91b7b0b5b8bfb6a2b8b6bfb0bdffb2bebc" target="_blank">Contact</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="bs-component">
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="https://www.cordcutting.com/" target="_blank">Cordcutting.com</a>, 
                                ...
                                <a href="https://indexed.dk/" target="_blank">Indexed</a>, 
                                ...
                                <a href="https://www.playpilot.com/" target="_blank">Playpilot</a>,
                                <a href="https://gowatch.io" target="_blank">GoWatch</a>,
                                <a href="https://www.ubaruv.io/podcast" target="_blank">Victor Ubaru (Podcast)</a>,
        ...
        <div class="bs-docs-section" id="changeLog">
            ...
            <ul>
                <li>11/02/17
                    <ul>
                        <li><b>FREE KEYS!</b> The "open" API is finally open again!</li>
                    </ul>
                </li>
                <li>08/20/17
                    <ul>
                        <li>I created a <a href="https://github.com/omdbapi/OMDb-API/issues" target="_blank">GitHub repository</a> for tracking bugs.</li>
                    </ul>
                </li>
                <li>05/10/17
                    <ul>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>API by <a href="/cdn-cgi/l/email-protection#b2d0d4c0dbc6c8f2d4d3d6dbdcd5c1dbd5dcd3de9cd1dddf">Brian Fritz</a>.</p>
    ...
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://www.google.com/recaptcha/api.js?render=6LfWPbsUAAAAALssRfr3Lhv9PdEEOAQXGdZohXbP"></script>
    <script>
